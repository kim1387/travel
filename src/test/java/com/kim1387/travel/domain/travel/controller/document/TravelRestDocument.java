package com.kim1387.travel.domain.travel.controller.document;
  ...
  public static RestDocumentationResultHandler getCreateTravelInfoDocument() {
    return document(
        ...
        responseFields(
            ...
            fieldWithPath("data.startTravelAt")
                .type(JsonFieldType.STRING)
                .description("travel 시작 일자"),
            fieldWithPath("data.endTravelAt")
                .type(JsonFieldType.STRING)
                .description("travel 끝나는 일자")));
  }
